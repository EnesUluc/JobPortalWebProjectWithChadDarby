...
public class JobSeekerSaveController {
    ...
    public String savedJobs(Model model){
        ...
        List<JobSeekerSave> candidatesJob = jobSeekerSaveService.getCandidatesJob((JobSeekerProfile) currentUserProfile);

        for(JobSeekerSave jobSeekerSave: candidatesJob){
